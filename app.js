...
// Add this line near the top of the file, with other require statements
const ethereumAuthRouter = require("./lib/auth/ethereum/index.js");
...
app.locals.authProviders = {
  ...
  ethereum: config.isEthereumEnable,
};
...
// Add the Ethereum authentication route
app.use(ethereumAuthRouter);
